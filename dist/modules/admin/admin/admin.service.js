...
const login = async (data) => {
    const validatedData = admin_validation_1.adminLoginSchema.parse(data);
    // Use better-auth to sign in the user
    const signInResult = await auth_1.auth.api.signInEmail({
        body: {
...
const updateUserStatus = async (userId, data) => {
    const validatedData = admin_validation_1.updateUserStatusSchema.parse(data);
...
exports.AdminService = { login, getUsers, updateUserStatus, getAllBookings, cancelBooking, getPlatformStats };
