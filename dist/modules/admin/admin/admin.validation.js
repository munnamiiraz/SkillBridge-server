...
exports.updateSubjectSchema = exports.createSubjectSchema = exports.updateCategorySchema = exports.createCategorySchema = exports.banUserSchema = exports.updateUserStatusSchema = exports.adminLoginSchema = void 0;
...
exports.banUserSchema = zod_1.z.object({
    banReason: zod_1.z.string().min(1, "Ban reason is required").max(500, "Ban reason must be less than 500 characters")
});
