...
export const updateTutorProfileSchema = z.object({
    bio: z.string().transform(val => val?.trim() || undefined).pipe(z.string().min(10, "Bio must be at least 10 characters").max(1000, "Bio too long").optional()).optional(),
    headline: z.string().transform(val => val?.trim() || undefined).pipe(z.string().min(5, "Headline must be at least 5 characters").max(200, "Headline too long").optional()).optional(),
    ...
    education: z.string().transform(val => val?.trim() || undefined).pipe(z.string().min(5, "Education must be at least 5 characters").max(500, "Education too long").optional()).optional(),
...
//# sourceMappingURL=tutor.validation.js.map