...
exports.updateAllTutorStats = updateAllTutorStats;
const prisma_1 = require("../lib/prisma");
async function updateAllTutorStats() {
    console.log("Starting tutor stats update...");
    try {
        // Get all tutor profiles
        const tutorProfiles = await prisma_1.prisma.tutor_profile.findMany({
            select: { id: true }
        });
        ...
        for (const tutorProfile of tutorProfiles) {
            ...
            await prisma_1.prisma.tutor_profile.update({
