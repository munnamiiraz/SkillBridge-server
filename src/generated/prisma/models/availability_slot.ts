...
// @ts-nocheck 
/*
 * This file exports the `availability_slot` model and its related types.
 *
...
export type GetAvailability_slotAggregateType<T extends Availability_slotAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAvailability_slot[P]>
    : Prisma.GetScalarType<T[P], AggregateAvailability_slot[P]>
}
...
type GetAvailability_slotGroupByPayload<T extends availability_slotGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Availability_slotGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Availability_slotGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Availability_slotGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Availability_slotGroupByOutputType[P]>
      }
    >
  >
...
export type availability_slotCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface availability_slotDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends availability_slotCountArgs>(
    args?: Prisma.Subset<T, availability_slotCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Availability_slotCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, availability_slotGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAvailability_slotGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
