...
// @ts-nocheck 
/*
 * This file exports the `tutor_profile` model and its related types.
 *
...
export type GetTutor_profileAggregateType<T extends Tutor_profileAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTutor_profile[P]>
    : Prisma.GetScalarType<T[P], AggregateTutor_profile[P]>
}
...
type GetTutor_profileGroupByPayload<T extends tutor_profileGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Tutor_profileGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Tutor_profileGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Tutor_profileGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Tutor_profileGroupByOutputType[P]>
      }
    >
  >
...
export type tutor_profileCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface tutor_profileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends tutor_profileCountArgs>(
    args?: Prisma.Subset<T, tutor_profileCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Tutor_profileCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, tutor_profileGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTutor_profileGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
