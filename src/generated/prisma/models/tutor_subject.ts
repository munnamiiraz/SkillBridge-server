...
// @ts-nocheck 
/*
 * This file exports the `tutor_subject` model and its related types.
 *
...
export type GetTutor_subjectAggregateType<T extends Tutor_subjectAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTutor_subject[P]>
    : Prisma.GetScalarType<T[P], AggregateTutor_subject[P]>
}
...
type GetTutor_subjectGroupByPayload<T extends tutor_subjectGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Tutor_subjectGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Tutor_subjectGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Tutor_subjectGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Tutor_subjectGroupByOutputType[P]>
      }
    >
  >
...
export type tutor_subjectCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface tutor_subjectDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends tutor_subjectCountArgs>(
    args?: Prisma.Subset<T, tutor_subjectCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Tutor_subjectCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, tutor_subjectGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTutor_subjectGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
